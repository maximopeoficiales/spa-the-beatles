export function CardAlbums(props) {
  let { id, albumName, genre, trackCount, created_at } = props;
  return `
        <article class="p-2 rounded-lg shadow-lg ">
          ...
          <div class="text-gray-700 text-base">
           ...
           <a href="./#/albums/${id}" class="text-center px-2 py-2 my-2 block rounded-lg bg-indigo-700 text-white font-semibold">Ver mas</a>
        </article>
     `;
}
